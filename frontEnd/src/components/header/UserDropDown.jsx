...
import {DropdownItem} from "../../assets/dropdown/DropDownItem";
    ...
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          <img src="/images/user/profile.jpg" alt="User" className="object-fit-cover" />
        </span>

        <span className="block mr-1 font-medium text-theme-sm">{auth.prenom || ""}{" "}{auth.nom || ""}</span>
        <svg
